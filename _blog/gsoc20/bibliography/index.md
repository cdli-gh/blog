...
|2| :heavy_check_mark: Implement linking publications to editors using the Author-Publication link pages. <br> :heavy_check_mark: Fixing bugs in the view pages and, creating add, edit and delete functions for authors data. <br> Implement bulk upload of publications using CSV files.  | :heavy_check_mark: Feature for linking editors and publications :heavy_check_mark: Features for managing authors data. <br> Feature for bulk upload of publications.  |  
...
|4| Making all the suggested changes to the link features. (suggestion on PRs [!122](https://gitlab.com/cdli/framework/-/merge_requests/122) and [!123](https://gitlab.com/cdli/framework/-/merge_requests/123)) <br> Document the completed features.  |  Improvements to the link features. <br>  Documentation for all the completed features. |  
